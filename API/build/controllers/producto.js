...
exports.ActualizarProducto = exports.DeleteProducto = exports.PostProducto = exports.GetProducto = exports.GetProductos = void 0;
const serviceProducto = __importStar(require("../services/producto"));
const GetProductos = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let data = yield serviceProducto.ListarProductos();
        return data;
    }
    catch (error) {
        throw error;
...
const GetProducto = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let data = yield serviceProducto.ListarProducto(id);
        return data;
    }
    catch (error) {
        throw error;
...
const PostProducto = (producto) => __awaiter(void 0, void 0, void 0, function* () {
    try {
